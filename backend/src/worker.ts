...
import { registerMetricsRetentionProcessor } from "./jobs/metricsRetention.processor.js";
...
async function bootstrapWorker() {
  try {
    ...
    await registerMetricsRetentionProcessor();
    logInfo("worker.started", { queues: ["exports", "export-cleanup", "metric-snapshots", "alert-evaluation", "metrics-retention"] });
  } catch (error) {
